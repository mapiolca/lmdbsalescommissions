...
/**
 * Manual commission dispatch attached to a customer proposal.
 */
class LmdbSalesCommissionProposalDispatch extends LmdbSalesCommissionCommon
{
	...
	public $fk_user;
	/** @var string|null margin or turnover */
	public $base_type;
	/** @var string|null amount or percentage */
	public $value_type;
	/** @var float|string|null Fixed amount or percentage */
	public $value;
	/** @var string|null automatic or explicit */
	public $payment_term_mode;
	/** @var int|string|null Explicit payment term id */
	...
	public $fields = array(
		...
		'base_type' => array('type' => 'varchar(16)', 'label' => 'LmdbSalesCommissionsDispatchBase', 'enabled' => '1', 'visible' => 1, 'notnull' => 1, 'position' => 30),
		'value_type' => array('type' => 'varchar(16)', 'label' => 'LmdbSalesCommissionsDispatchValueType', 'enabled' => '1', 'visible' => 1, 'notnull' => 1, 'position' => 40),
		'value' => array('type' => 'double(24,8)', 'label' => 'Value', 'enabled' => '1', 'visible' => 1, 'notnull' => 1, 'default' => '0', 'position' => 50),
		'payment_term_mode' => array('type' => 'varchar(16)', 'label' => 'LmdbSalesCommissionsDispatchPaymentMode', 'enabled' => '1', 'visible' => 1, 'notnull' => 1, 'default' => 'automatic', 'position' => 60),
		'fk_payment_term' => array('type' => 'integer', 'label' => 'LmdbSalesCommissionsPaymentTerms', 'enabled' => '1', 'visible' => 1, 'position' => 70),
		'note_private' => array('type' => 'text', 'label' => 'NotePrivate', 'enabled' => '1', 'visible' => 0, 'position' => 80),
