...
print load_fiche_titre($langs->trans('LmdbSalesCommissionsTracking'), '', 'fa-percent');
...
print $langs->trans('LmdbSalesCommissionsRuleSource').' '.$form->selectarray('search_rule_source', array('user' => $langs->trans('User'), 'group' => $langs->trans('Group'), 'default' => $langs->trans('Default')), $search_rule_source, 1, 0, 0, '', 0, 0, 0, '', 'minwidth100', 1).' ';
